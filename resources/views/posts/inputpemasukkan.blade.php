...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ url('asetss/images/favicon.jpg') }}">
    ...
    <!-- icheck checkboxes -->
    <link rel="stylesheet" href="{{ url('asetss/icheck/square/yellow.css') }}">
    {{-- <link rel="stylesheet" href="https://raw.githubusercontent.com/fronteed/icheck/1.x/skins/square/yellow.css"> --}}

    <!-- toastr notifications -->
    {{-- <link rel="stylesheet" href="{{ url('asetss/toastr/toastr.min.css') }}"> --}}
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css">


    <!-- Font Awesome -->
    {{-- <link rel="stylesheet" href="{{ url('asetss/font-awesome/css/font-awesome.min.css') }}"> --}}
...
<body>
    ...
    <!-- toastr notifications -->
    {{-- <script type="text/javascript" src="{{ url('asetss/toastr/toastr.min.js') }}"></script> --}}
    <script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>

    <!-- icheck checkboxes -->
    <script type="text/javascript" src="{{ url('asetss/icheck/icheck.min.js') }}"></script>
